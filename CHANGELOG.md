...
### Fixed
- Progress indicator doesn't have elapsed time with minimal verbosity.
...
### Fixed
- backend deployment failure due to existing AppPlan with same name in different reqion.
- backend deployment failure due to existing event grid system topic.
